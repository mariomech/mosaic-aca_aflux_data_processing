...
os.chdir('.../processing/')
from Utility_MOSAiC_AFLUX_pms import save_icar_combined_mosaic, calc_IWC, calc_LWC, create_n_endbins, bin_df_from_edges, column_names2, get_dNdD, bin_to_1um_res_new, seconds_since_midnight, datetime_from_utcs, bin_df_from_edges, column_names, calc_LWC, calc_MVD, get_dN, calc_ED, save_icar_cas_aflux
import statistics



#############################################################################
#start: import the processed pkl files from cdp, cip and pip; combined pkl file is created



########awi:
cgawi_data = pd.read_pickle('C:/Users/mose_mn/Documents/Kampagnen/MOSAiC_ACAS/Auswertung/NASA-AMES/CGAWI_files_nochnichtgemacht/mosaic_cgawi.pkl')
cgawi_data['datetime'] = cgawi_data.index


#########pip:
pip_data = pd.read_pickle(r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Auswertung\NASA-AMES\PIP\20210811_PIP_AMES_Files\mosaic_pip_data_df.pkl')
pip_bin = pd.read_pickle(r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Auswertung\NASA-AMES\PIP\20210811_PIP_AMES_Files\mosaic_pip_bin_df.pkl')
bin_df_pip = pip_bin
dNdD_names_pip, dn_names_pip = column_names(bin_df_pip)

#########cip:
cip_data = pd.read_pickle(r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Auswertung\NASA-AMES\CIP\20210811_CIP_AMES_Files\mosaic_cip_data_df.pkl')
cip_bin = pd.read_pickle(r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Auswertung\NASA-AMES\CIP\20210811_CIP_AMES_Files\mosaic_cip_bin_df.pkl')
bin_df_cip = cip_bin
dNdD_names_cip, dn_names_cip = column_names(cip_bin)


#########cdp:
cdp_data = pd.read_pickle(r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Auswertung\NASA-AMES\CDP\20210804_CDP_AMES_Files\mosaic_cdp_data_df.pkl')
cdp_bin = pd.read_pickle(r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Auswertung\NASA-AMES\CDP\20210804_CDP_AMES_Files\mosaic_cdp_bin_df.pkl')
bin_df_cdp = cdp_bin
...
combined_df.insert(4, 'LWC_50', calc_LWC(get_dN(combined_df[combined_columns[:16]],combined_bin_df[:16]*1e-6), (combined_bin_df[:16]['bin_mid']*1e-6).to_numpy())[0]  ) #lwc for p. smaller 52
combined_df.insert(5, 'IWC_50', calc_IWC(get_dN(combined_df[combined_columns[16:]],combined_bin_df[16:]*1e-6), (combined_bin_df[16:]['bin_mid']*1e-6).to_numpy())[0]  ) #iwc for p. larger 52
...
combined_df.to_pickle('C:/Users/mose_mn/Documents/Kampagnen/MOSAiC_ACAS/Auswertung/NASA-AMES/pms_combined/mosaic_pms_combined.pkl')
combined_bin_df.to_pickle('C:/Users/mose_mn/Documents/Kampagnen/MOSAiC_ACAS/Auswertung/NASA-AMES/pms_combined/mosaic_pms_combined_bins.pkl')


with open(r'C:/Users/mose_mn/Documents/Kampagnen/MOSAiC_ACAS/Auswertung/NASA-AMES/pms_combined/overlaps_for_pkl.txt', 'w') as f:
...
pms_combined = pd.read_pickle('C:/Users/mose_mn/Documents/Kampagnen/MOSAiC_ACAS/Auswertung/NASA-AMES/pms_combined/mosaic_pms_combined.pkl')
pms_combined_bins = pd.read_pickle('C:/Users/mose_mn/Documents/Kampagnen/MOSAiC_ACAS/Auswertung/NASA-AMES/pms_combined/mosaic_pms_combined_bins.pkl')
...
directory = r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Auswertung\NASA-AMES\pms_combined'
...
for i in range(len(days_of_campaign)):
    ...
    t_start = data_df.index[0]
    save_icar_combined_mosaic(data_df, bin_df, campaign, probe, platform, flight, directory)
