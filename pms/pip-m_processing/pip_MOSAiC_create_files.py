...
import xarray as xr
os.chdir('.../processing/')
from Utility_MOSAiC_AFLUX_pms import save_icar_pip_mosaic, save_icar_pip_aflux, import_1Hz_pip_files_as_pd, seconds_since_midnight, sv_per_bin, reject_numbers, oap_dmt_sa_centerin, import_1Hz_cip_files_as_pd_aflux, create_endbins, datetime_from_utcs, bin_df_from_edges, column_names,calc_LWC, calc_MVD, save_icar_cdp, get_dN, calc_ED,calc_IWC, save_icar_cip_mosaic

#data has to be processed by SODA before, see IDL script "soda_process_pip.pro"

#############################################################################
#start: create buffer data file, with active time = constant = 1


path_1Hz_pip_20200831 = (r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Daten\20200831_certification\PIP')
path_1Hz_pip_20200902 = (r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Daten\20200902_F5\PIP')
path_1Hz_pip_20200904 = (r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Daten\20200904_F6\PIP')
path_1Hz_pip_20200907 = (r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Daten\20200907_F7_remote_sensing\PIP')
path_1Hz_pip_20200908 = (r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Daten\20200908_F8_insitu_over_ice\PIP')
path_1Hz_pip_20200910 = (r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Daten\20200910_F9_insitu_cover_ice\PIP')
path_1Hz_pip_20200911 = (r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Daten\20200911_F10_insitu_over_ice\PIP')
path_1Hz_pip_20200913 = (r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Daten\20200913_F11_ice_next_to_Greenland\PIP')



def make_pip_pandas_mosaic(year, month, day):
    dir_data = r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Auswertung\NASA-AMES\PIP' + str('\\')+str(year)+str(month).zfill(2)+str(day).zfill(2)
    data_nc_name = str(month).zfill(2)+str(day).zfill(2)+str(year)+'_000001_PIP.pbp.nc'
    tas_file = r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Auswertung\NASA-AMES\TAS_files'+ str('\\')+str(year)+str(month).zfill(2)+str(day).zfill(2) +'_TAS.txt'
...
data_pip_mosaic1 = make_pip_pandas_mosaic(2020, 8, 31)
data_pip_mosaic2 = make_pip_pandas_mosaic(2020, 9, 2)
data_pip_mosaic3 = make_pip_pandas_mosaic(2020, 9, 4)
data_pip_mosaic4 = make_pip_pandas_mosaic(2020, 9, 7)
data_pip_mosaic5 = make_pip_pandas_mosaic(2020, 9, 8)
data_pip_mosaic6 = make_pip_pandas_mosaic(2020, 9, 10)
data_pip_mosaic7 = make_pip_pandas_mosaic(2020, 9, 11)
data_pip_mosaic8 = make_pip_pandas_mosaic(2020, 9, 13)


mosaic_pip = pd.DataFrame(columns = data_pip_mosaic1.columns)
mosaic_pip = mosaic_pip.append(data_pip_mosaic1)
mosaic_pip = mosaic_pip.append(data_pip_mosaic2)
mosaic_pip = mosaic_pip.append(data_pip_mosaic3)
mosaic_pip = mosaic_pip.append(data_pip_mosaic4)
mosaic_pip = mosaic_pip.append(data_pip_mosaic5)
mosaic_pip = mosaic_pip.append(data_pip_mosaic6)
mosaic_pip = mosaic_pip.append(data_pip_mosaic7)
mosaic_pip = mosaic_pip.append(data_pip_mosaic8)

mosaic_pip.to_pickle('C:/Users/mose_mn/Documents/Kampagnen/MOSAiC_ACAS/Auswertung/NASA-AMES/PIP/mosaic_pip_at1.pkl')
...
pip_data_df = pd.read_pickle('C:/Users/mose_mn/Documents/Kampagnen/MOSAiC_ACAS/Auswertung/NASA-AMES/PIP/mosaic_pip_at1.pkl')
...
#pkl files:
directory = r'C:/Users/mose_mn/Documents/Kampagnen/MOSAiC_ACAS/Auswertung/NASA-AMES/PIP/20210811_PIP_AMES_Files' # directory where NASA-Ames Files get saved
pip_data_df[['datetime','N', 'LWC', 'IWC', 'MVD', 'ED'] + dNdD_names_pip].to_pickle(directory+'/mosaic_pip_data_df.pkl')
pip_bin_df.to_pickle(directory+'/mosaic_pip_bin_df.pkl')
...
for i in range(len(days_of_campaign)):
    ...
    t_start = data_df.index[0]
    save_icar_pip_mosaic(data_df, bin_df, campaign, probe, platform, flight, directory)
