...
import xarray as xr
os.chdir('.../processing/')
from Utility_MOSAiC_AFLUX_pms import import_1Hz_cip_files_as_pd, seconds_since_midnight, sv_per_bin, reject_numbers, oap_dmt_sa_centerin, import_1Hz_cip_files_as_pd_aflux, create_endbins, datetime_from_utcs, bin_df_from_edges, column_names,calc_LWC, calc_MVD, save_icar_cdp, get_dN, calc_ED,calc_IWC, save_icar_cip_mosaic

#data has to be processed by SODA before, see IDL script "soda_process_cip.pro"
...
path_1Hz_cip_20200830 = (r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Daten\20200830_testflight\CCP')
path_1Hz_cip_20200831 = (r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Daten\20200831_certification\CCP')
path_1Hz_cip_20200902 = (r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Daten\20200902_F5\CCP')
path_1Hz_cip_20200904 = (r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Daten\20200904_F6\CCP')
path_1Hz_cip_20200907 = (r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Daten\20200907_F7_remote_sensing\CCP')
path_1Hz_cip_20200908 = (r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Daten\20200908_F8_insitu_over_ice\CCP')
path_1Hz_cip_20200910 = (r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Daten\20200910_F9_insitu_cover_ice\CCP')
path_1Hz_cip_20200911 = (r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Daten\20200911_F10_insitu_over_ice\CCP')
path_1Hz_cip_20200913 = (r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Daten\20200913_F11_ice_next_to_Greenland\CCP')

def make_cip_pandas_mosaic(year, month, day):
    dir_data = r'C:\Users\mose_mn\Documents\Kampagnen\MOSAiC_ACAS\Auswertung\NASA-AMES\CIP' + str('\\')+str(year)+str(month).zfill(2)+str(day).zfill(2)
    ...
    #info: all in bedeutet nicht nur all in sondern auch center in, je nach dem was für ein eaw eingestellt ist
    ...
    oap_1Hz = import_1Hz_cip_files_as_pd( eval('path_1Hz_cip_'+str(year)+str(month).zfill(2)+str(day).zfill(2)), year, month, day)
...
data_cip_mosaic1 = make_cip_pandas_mosaic(2020, 8, 31)
data_cip_mosaic2 = make_cip_pandas_mosaic(2020, 9, 2)
data_cip_mosaic3 = make_cip_pandas_mosaic(2020, 9, 4)
data_cip_mosaic4 = make_cip_pandas_mosaic(2020, 9, 7)
data_cip_mosaic5 = make_cip_pandas_mosaic(2020, 9, 8)
data_cip_mosaic6 = make_cip_pandas_mosaic(2020, 9, 10)
data_cip_mosaic7 = make_cip_pandas_mosaic(2020, 9, 11)
data_cip_mosaic8 = make_cip_pandas_mosaic(2020, 9, 13)


mosaic_cip = pd.DataFrame(columns = data_cip_mosaic1.columns)
mosaic_cip = mosaic_cip.append(data_cip_mosaic1)
mosaic_cip = mosaic_cip.append(data_cip_mosaic2)
mosaic_cip = mosaic_cip.append(data_cip_mosaic3)
mosaic_cip = mosaic_cip.append(data_cip_mosaic4)
mosaic_cip = mosaic_cip.append(data_cip_mosaic5)
mosaic_cip = mosaic_cip.append(data_cip_mosaic6)
mosaic_cip = mosaic_cip.append(data_cip_mosaic7)
mosaic_cip = mosaic_cip.append(data_cip_mosaic8)

#mosaic_cip.to_pickle('C:/Users/mose_mn/Documents/Kampagnen/MOSAiC_ACAS/Auswertung/NASA-AMES/CIP/mosaic_cip_at_1.pkl')
