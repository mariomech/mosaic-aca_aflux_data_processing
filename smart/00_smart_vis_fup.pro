...
datum='200913'
sav_suffix='_fup_210519_vis.sav'

cd, idl_path

hh_files=['09','10','11','12','13','14','15']
...
files=file_search(data_dir+'ALBEDO_'+daystring1+'_'+hhsuch+'*.VIS-A_ch2.dat') ; neu
...
if id_spectroButton eq 0 and id_rangebutton eq 0 then calibfile=directory_calib+'calfac_fup_VIS_1000ms_210518_nachkalib_transfer_till_200912.dat';
...
save, file=outputfile, wl, time_all, spec_all, height_all, sza_all, saa_all
