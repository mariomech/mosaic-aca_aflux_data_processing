...
datum='200904'
sav_suffix='_fup_210519_nir.sav'
cloud=1

hh_files=['14','15','16','17']
...
if id_spectroButton eq 0 and id_rangebutton eq 0 then filters='ALBEDO*.2.dat'; irradiance VIS

if id_spectroButton eq 1 and id_rangebutton eq 0 then filters='*VIS.dat'; radiance VIS

if id_spectroButton eq 0 and id_rangebutton eq 1 then filters='nir*1.dat'; irradiance NIR
...
files=file_search(data_dir+'NIR_'+daystring1+'_'+hhsuch+'*1.dat') ; neu
...
if id_rangebutton eq 1 then begin ; für NIR Spektro radiance or irradiance
    ...
    ntotal=n_elements(tint)
    for i=0,ntotal-1 do begin
        calibfile=directory_calib+'calfac_fup_NIR_500ms_210518_nachkalib.dat'
       ...
       if tint(i) eq 1000. then absfac=absfac/2.
...
if sensor eq 'VN4' or sensor eq 'irr_A' then begin
;    for i=0,ntotal-1 do begin
    for i=0,ntotal-1 do begin
...
diff_corr[*]=0.96 ;vis =0.93, nir=0.96
