...
ncdf_path = '/projekt_agmwend2/data_raw/MOSAiC_raw/Pangaea_Files/NetCDF_files/AisaEAGLE_4/'
...
flight_dirs = MOSAiC_path + 'Flight_' + dates + '/AisaEAGLE/'
...
;
           ...
           varID_wl = ncdf_vardef(id,'wavelength',[dim0], GZIP=3)
           ncdf_attput, id, VarId_wl, 'Long name', 'Wavelength'
           ncdf_attput, id, VarId_wl, 'Units','nm'
       ENDIF

       IF max(img_eagle) LT 32767 THEN varID_img = ncdf_vardef(id,'radiance_' + hour,[dim1,dim0,dim2],/short, GZIP=3) $
       ELSE varID_img = ncdf_vardef(id,'radiance_' + hour,[dim1,dim0,dim2],/long, GZIP=3)
